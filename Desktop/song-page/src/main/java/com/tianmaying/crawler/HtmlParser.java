...
import com.tianmaying.crawler.model.MusicComment;
import com.tianmaying.crawler.model.MusicCommentMessage;
import com.tianmaying.crawler.utils.Constants;
import com.tianmaying.crawler.utils.EncryptUtils;
...
public class HtmlParser {
    ...
    public Long parseSong(String url) {
        try {
            MusicCommentMessage mcm = parseCommentMessage(url);
            System.out.println(mcm.getSongTitle()+" "+mcm.getSongUrl());
            List<MusicComment> listOfMC = mcm.getComments();
            for(MusicComment mc : listOfMC){
    ...
    public static MusicCommentMessage parseCommentMessage(String url) throws Exception {
        String songUrl = url;
